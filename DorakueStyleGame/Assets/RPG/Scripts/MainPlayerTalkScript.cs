...
public class MainPlayerTalkScript : MonoBehaviour
{
    //会話可能な相手
    ...
    private void LateUpdate()
    {
        ...
        {
            talkIcon.transform.Find("Panel").position = Camera.main.GetComponent<Camera>().WorldToScreenPoint(conversationPartner.transform.position + Vector3.up * 2.5f);
        }
    }
    ...
    void EndTalking()
    {
        ...
        GetComponent<MainPlayerScript>().SetState(MainPlayerScript.State.Normal);
        Input.ResetInputAxes();
    }
}
